//----------------------------------------------------------------------------------
//! kBasics namespace contains all often used functions, for examples for conversions.
/*!
// \file    kBasics.h
...
//! kBasics contains all often used functions, for examples for conversions.
namespace kBasics
{
  struct optionstruct{
    string name;
  ...
  //! Often used point data structure located in namespace kBasics.
  struct POINT {
    int x,y;
  ...
  //! Often used point data structure with floating point corner located in namespace kBasics.
  struct POINTF {
    float x,y;
  ...
  //! Often used line data structure located in namespace kBasics.
  struct LINE {
    POINT p1,p2;
  };

  //! Often used line data structure with floating point corners located in namespace kBasics.
  struct LINEF {
    POINTF p1,p2;
  };


  //! Often used box data structure located in namespace kBasics.
  struct BOX {
