...
class point_2d{
	public:
		point_2d();
		point_2d(unsigned int x, unsigned int y);
		void set(unsigned int x, unsigned int y);
		void get(unsigned int &x, unsigned int &y) const;
...
public:
	...
	unsigned int y2;
	rect_range();
	rect_range(unsigned int ax1, unsigned int ax2, unsigned int ay1, unsigned int ay2);
...
public:
	...
	void scale(unsigned int minimum, unsigned int maximum);
