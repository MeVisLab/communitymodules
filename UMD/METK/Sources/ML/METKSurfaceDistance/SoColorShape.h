...
//! Inventor node SoColorShape derived from SoGroup.
//! \file SoColorShape.h
...
//! Helper/tool class for the Inventor node SoColorShape.
class Vertex {
public:
...
//! Sort criterion for the hashtable set, used by the the Inventor node SoColorShape.
struct ltVertex {
...
//! Sort criterion for the edge set, used by the the Inventor node SoColorShape.
struct ltEdge {
