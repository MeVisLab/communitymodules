...
//! \def SPLINE_EXPORT Defines library import/export macros necessary to use a shared
//!                    library interface on some platforms.
  ...
  // Make use of the new style and platform independent import/export definitions.
    ...
    #define SPLINE_EXPORT   ML_LIBRARY_EXPORT_ATTRIBUTE
  #else
    // If included by external modules, exported symbols are declared as import symbols
    #define SPLINE_EXPORT   ML_LIBRARY_IMPORT_ATTRIBUTE
  #endif
#else
