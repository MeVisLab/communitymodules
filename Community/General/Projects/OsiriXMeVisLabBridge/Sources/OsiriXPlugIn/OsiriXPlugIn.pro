...
macx:release:!debug {
  ...
  clang {
    !system(xcodebuild -configuration Release GCC_VERSION=com.apple.compilers.llvm.clang.1_0 SDKROOT=macosx$$QMAKE_MACOSX_DEPLOYMENT_TARGET clean build):error(Build error.)
  } else {
